...
const cardData = [
  {
    ...
    descDefault: 'English sparks interest, invites exploration, and makes discovery enjoyable.',
  ...
  },
  {
    ...
    titleDefault: 'Consistency without force',
    descKey: 'develop.cards.persistence.desc',
    descDefault: 'The child keeps engaging with the language naturally, without pressure.',
  ...
  },
  {
    ...
    descDefault: 'The child feels safe to explore, make mistakes, and continue learning. They develop self-confidence.',
  ...
  },
  {
    ...
    descDefault: 'The child participates, explores, and progresses with increasing independence.',
